...
namespace Gvc {
	...
	[CCode (cname = "char", copy_function = "agdupstr_html", free_function = "")]
	public class HtmlString : string {
		[CCode (cname = "agstrdup_html")]
		public static HtmlString make_html (Graph graph, string markup);

        [CCode (cname = "agstrfree")]
        public static HtmlString free_html (Graph graph, string markup);
	}
